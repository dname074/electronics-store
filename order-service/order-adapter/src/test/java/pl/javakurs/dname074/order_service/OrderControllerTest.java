...
public class OrderControllerTest {
    ...
    void createOrder_DataCorrect_201Returned() throws Exception {
        ...
        CreateOrderCommand createOrderCommand = new CreateOrderCommand(cartId, customer);
        ...
        Order order = new Order(1L, OrderStatus.CREATED, BigDecimal.valueOf(5000), products,
                new Customer(1L, "Jan", "Kowalski", "Polska", "Warszawa", "50-660", "Szybka", 8, null),
